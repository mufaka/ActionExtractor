...
def show_verb_phrases_for_sentences(nlp, sentences):
    sentence_docs = list(nlp.pipe(sentences))
    for sentence_doc in sentence_docs:
        show_verb_phrases(nlp, sentence_doc)

# match verb noun, verb something noun, verb something something noun.
def show_imperative_phrases(nlp, doc):
...
# attempt at imperative phrases
def show_imperative_phrases_for_sentences(nlp, sentences):
    sentence_docs = list(nlp.pipe(sentences))
    for sentence_doc in sentence_docs:
        show_imperative_phrases(nlp, sentence_doc)
